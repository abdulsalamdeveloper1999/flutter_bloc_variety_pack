...
import 'package:bloc_and_bloc_cubit/flutter_bloc_pattern_wheather_app/bloc/wheather_event.dart';
import 'package:bloc_and_bloc_cubit/flutter_bloc_pattern_wheather_app/bloc/wheather_state.dart';
...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  void initState() {
    super.initState();
    context.read<WheatherBloc>().add(WeatherFetched());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<WheatherBloc, WeatherState>(
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Convert the dtTxt string to a DateTime object
